...
<div class="panel panel-default">
	<div class="panel-heading">
		<?php echo trans('heading.company_list') ?>
	</div>
	<!-- panel heading -->
	...
	<div class="navbar nav-toolbar">
		<div class="navbar-form">
			<div class="navbar-left">
				<a class="btn btn-primary" href="<?php echo url('member/company/add') ?>">
					<?php echo trans('label.btn_company_add') ?>
				</a>
			</div>
	...
	<?php if(isset($result) && $result->total): ?>
		...
		<table class="table table-list table-striped table-hover">
			<thead>
				<tr>
					<th class="td-no">#</th>
					<th><?php echo trans('label.td_company_name') ?></th>
					<th><?php echo trans('label.td_company_url') ?></th>
			...
			<tbody>
				<?php $i=0+($result->from-1); foreach($result->data as $row): ?>
					...
					<tr>
						...
						<td><?php echo SG_Util::val($row, 'company_slug') ?></td>
						<td class="td-action">
							<a href="<?php echo url('member/company/edit/'.$company_id) ?>">
								<i class="fa fa-pencil"></i> <?php echo trans('label.action_edit') ?>
							</a>
							<a href="<?php echo url('member/company/delete/'.$company_id) ?>">
